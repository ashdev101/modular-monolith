...
const bindTransactionConnection_1 = require("../binders/bindTransactionConnection");
...
const execNestedTransaction = async (parentLog, connection, clientConfiguration, handler, newTransactionDepth) => {
    ...
    try {
        const result = await handler((0, bindTransactionConnection_1.bindTransactionConnection)(parentLog, connection, clientConfiguration, newTransactionDepth));
        return result;
    }
    catch (error) {
